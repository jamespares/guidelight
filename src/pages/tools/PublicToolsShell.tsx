...
/**
 * Public (no-login) shell for the free tools — same sticky-header layout as
 * the graded-stories and flashcards pages.
 */
export function PublicToolsShell({ children }: { children: ReactNode }) {
  return (
